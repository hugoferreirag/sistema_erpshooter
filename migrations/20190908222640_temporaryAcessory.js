exports.up = function(knex, Promise) {
    return knex.schema.createTable('temporary_acessory', table=>{
        table.increments('id').primary()
        table.integer('user_id').notNull()
        table.string('acessory').notNull()
        table.string('acessory_code').notNull()
  ...
  exports.down = function(knex, Promise) {
      return knex.schema.dropTable('temporary_acessory')
  };
